 ...
 * @returns {Object} null
 */
module.exports.respondWithSuccess = (res,statusCode = 200,message,additionalFields = {}) => {
 ...
 * @returns {Object} null
 */
module.exports.respondWithWarning = (res, statusCode = 500, message, additionalFields = {}) => (
  res
    .status(statusCode)
